...
<div class="container">
  ...
  <!-- Один блок .resume-company = одна компания.
       Если в этой компании было несколько должностей — добавляй под ней
       несколько .resume-position, у каждой свой срок и своё описание. -->
  ...
  <!--
    У каждого инструмента — своя строка span.tool-tag с вложенным
    span.tool-tag__level. Меняй только цифру в data-level: 1 — начальный
    уровень, 2 — средний, 3 — уверенное владение.
  -->
  <div class="tool-tags">
  ...
  <p class="tool-tags__legend">●○○ начальный уровень владения инструментом · ●●○ средний уровень владения инструментом · ●●● высокий уровень владения инструментом</p>
</div>